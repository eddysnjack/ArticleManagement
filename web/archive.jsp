<%-- 
    Document   : archive
    Created on : 16.Ara.2018, 12:36:53
    Author     : eddy
--%>
...
<c:forEach items="${ListofFiles}" var="item">
    <div class="card" style="width: 18rem;">
        <img class="card-img-top" src="${pageContext.request.contextPath}/images/edit-document.svg" style="max-width: 100px" alt="Card image cap">
            <div class="card-body">
                ...
                <a href="${pageContext.request.contextPath}/servletFileUpload?Stream=Download&filePath=${item.getFilePath()}" class="btn btn-primary">Dosyayı indir</a>
            </div>
    </div>
</c:forEach>

<span style="margin-top: 5em;">${NoResults}</span>
