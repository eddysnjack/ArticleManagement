...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark rounded fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="form-inline" style="padding-right: 5%;">
                <ul class="nav mr-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/writer/profile.jsp">Profili Düzenle</a>
...
<div class="container" style="text-align: center">
    <a class="btn btn-info"  id="btn_YeniGelen" href="${pageContext.request.contextPath}/servletControlPoint?Select=WriterAllWaiting">
        Editör Onay Bekleyenler
        <span class="badge badge-warning badge-pill">${FileNumber1}</span>
    </a>
    <a class="btn btn-primary" id="btn_HeyetBekleyen" name ="heyetOnayi" href="${pageContext.request.contextPath}/servletControlPoint?Select=WriterAllEditorApproved">
        Heyet Onayı Bekleyen
        <span class="badge badge-warning badge-pill">${FileNumber2}</span>
    </a>
    <a class="btn btn-success" id="btn_Onaylanmis" name ="yayinlanmis" href="${pageContext.request.contextPath}/servletControlPoint?Select=WriterAllPublished">
        Yayınlanmış
        <span class="badge badge-warning badge-pill">${FileNumber3}</span>
    </a>

    <a class="btn btn-danger" id="btn_Reddedilmis" name ="yayinlanmis" href="${pageContext.request.contextPath}/servletControlPoint?Select=WriterAllRejected">
        Reddedilmiş
        ...
        <div class="card">
            ...
            <div
                ...
                <div class="whole-modal grid-item" style="display: inline-grid;grid-template-columns: 60% 40%;">
                    <button type="button" class="btn btn-light" data-toggle="modal" data-target="#DocumentViewModal${LoopIndex.count}">
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content" style="height: 500px;">
                                <div class="modal-header">
                                    ...
                                    <!-- Bu şekilde object ve embed birlikte kullanımı chrome ve firefox ta birlikte düzgün çalışması için. chrome'da bende kaydırmada problem var. ya da chromium versiyonum bug'lı. bilemiyorum -->
